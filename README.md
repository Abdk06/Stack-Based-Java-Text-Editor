...
A driver class is included too that runs the program, instantiates the Text Editor object and allows the user to give the path to the file they want to read the commands from.
